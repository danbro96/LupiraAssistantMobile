...
/** Create or return the caller's personal health record. Idempotent. HealthApi. */
...
/** Registers on LocationApi (which mints + validates the ingest key). Response carries the one-time apiKey — persist it immediately. */
